...
public class CharacterController : MonoBehaviour {
	...
	public GameObject FireObject,ParentFire,ParentFire2;
...
//        }
	...
	private void Fire(){//localPosition
		GameObject instantiatedHint = Instantiate(FireObject, ParentFire.transform.position, Quaternion.identity);
		
		instantiatedHint.transform.SetParent(ParentFire2.transform, false);
		instantiatedHint.transform.position = ParentFire.transform.position;
		instantiatedHint.AddComponent<Fire>();
	}
